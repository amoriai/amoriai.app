...
const STRINGS: Record<Locale, Strings> = {
  fr: {
    title: "Me connecter",
    subtitle: "Accède à ton AmorIA personnel et reprends la conversation.",
    google: "Continuer avec Google",
    or: "OU",
    emailLabel: "Adresse courriel",
    emailPlaceholder: "ex. mon.adresse@email.com",
    passwordLabel: "Mot de passe",
    passwordPlaceholder: "Ton mot de passe AmorIA",
    show: "Afficher",
    hide: "Masquer",
    submit: "Me connecter",
  ...
  en: {
    title: "Log in",
    subtitle: "Access your personal AmorIA and resume your conversation.",
    google: "Continue with Google",
    or: "OR",
    emailLabel: "Email address",
    emailPlaceholder: "e.g. my.address@email.com",
    passwordLabel: "Password",
    passwordPlaceholder: "Your AmorIA password",
    show: "Show",
    hide: "Hide",
    submit: "Log in",
  ...
  es: {
    ...
    subtitle: "Accede a tu AmorIA personal y continúa la conversación.",
    google: "Continuar con Google",
    or: "O",
    emailLabel: "Correo electrónico",
    emailPlaceholder: "ej. mi.direccion@email.com",
    passwordLabel: "Contraseña",
    passwordPlaceholder: "Tu contraseña de AmorIA",
    show: "Mostrar",
    hide: "Ocultar",
