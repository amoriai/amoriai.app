...
> = {
  fr: {
    ...
    noPlanInfo:
      "Tu choisiras ton forfait (gratuit ou payant) à l’étape suivante, sur la page des tarifs.",
  },
  en: {
    ...
    noPlanInfo:
      "You’ll choose your plan (free or paid) on the next step, on the pricing page.",
  },
  es: {
    ...
    noPlanInfo:
      "Elegirás tu plan (gratis o de pago) en el siguiente paso, en la página de precios.",
  },
};
...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      // Après Google → retour sur /pricing avec lang & plan
