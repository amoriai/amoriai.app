...
const PRIVACY_STRINGS: Record<Locale, PrivacyCopy> = {
  /* ——— TON GROS OBJET PRIVACY_STRINGS EXACTEMENT COMME TU L’AS COLLÉ ——— */
  /* je ne le recolle pas ici pour ne pas exploser le message, mais tu peux
     reprendre tel quel le bloc que tu viens de m'envoyer, sans rien changer */
};
...
export default function PrivacyPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="amoria-root">
      ...
      {/* même bloc <style jsx global> que sur la page Legal ci-dessus */}
    </main>
  );
}
