...
const LEGAL_STRINGS: Record<Locale, LegalCopy> = {
  fr: {
    ...
    heroSubtitle:
      "Conformément aux lois applicables au Québec et au Canada, cette page présente les informations relatives à l’éditeur, à l’hébergement et à l’utilisation du site AmorIAI.app.",
    sections: [
      {
...
Le service ne constitue pas un service médical, psychologique, d’urgence ou de conseil professionnel (juridique, financier, etc.).`,
      },
      {
        ...
        text: `Tous les éléments du site AmorIAI.app (textes, visuels, logo, identité graphique, avatars, code, structure des pages) sont protégés par le droit d’auteur et demeurent la propriété exclusive de Les Entreprises Kema inc., sauf mention contraire.
...
• the Terms of Use;
• the Privacy Policy.
These documents are available from the AmorIAI.app website.`,
      },
      {
...
These legal notices will be updated to reflect the change as soon as it becomes effective.`,
  ...
  es: {
    ...
    heroSubtitle:
      "De conformidad con las leyes aplicables en Quebec y Canadá, esta página presenta la información relativa al editor, al alojamiento y al uso del sitio AmorIAI.app.",
    sections: [
      {
...
Este servicio no sustituye servicios médicos, psicológicos, de urgencias ni de asesoramiento profesional (jurídico, financiero, etc.).`,
      },
      {
        ...
        text: `Todos los elementos del sitio AmorIAI.app (textos, imágenes, logotipo, identidad visual, avatares, código, estructura de las páginas) están protegidos por derechos de autor y son propiedad exclusiva de Les Entreprises Kema inc., salvo indicación contraria.
