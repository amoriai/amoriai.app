...
export default function PaymentPage() {
  ...
  // Si jamais quelqu’un arrive ici avec le plan gratuit, on le renvoie direct à create-amoria
    ...
    <main className="amoria-root amoria-payment-root">
      <div className="amoria-payment-wrapper">
        <div className="amoria-payment-card">
          ...
          {/* Tu peux adapter cette liste aux vraies features par plan */}
          <section className="amoria-payment-included">
            <p className="amoria-payment-included-label">{t.included}</p>
            <ul>
              <li>Accès 24/7 à AmorIA</li>
              <li>Messages illimités par texte</li>
              <li>Historique de conversation sauvegardé</li>
              {plan !== "chat" && <li>Appels vocaux IA (selon plan)</li>}
              {plan === "unlimited" && (
                <li>Accès prioritaire + nouveautés en avant-première</li>
              )}
            </ul>
          </section>
